...
import { authorConst, cancelButtonConst, deleteButtonConst, nameOfPublisherConst, saveButtonConst, titleLabelConst, authorNameConst, authorLastNameConst, addButton } from "../models/Constants";
import "./BookModalForAdd.css";
